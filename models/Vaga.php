...
class Vaga{
    ...
    public function detalhesVaga($id_vaga){
        return $result = Db::queryOne("select a.descricao as areainteresse, v.* from vaga v inner join areainteresse a on v.FK_Id_areainteresse = a.ID_areainteresse where v.ID_vaga=?", array($id_vaga));
    }
